          ...
          >
            <Card className="card-enhanced">
              <CardHeader>
                ...
                <p className="text-gray-600">
                  Pourquoi nous privilégions le contact direct plutôt que les formulaires web.
                </p>
              </CardHeader>
              <CardContent className="space-y-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-800 text-sm leading-relaxed">
                        ...
                        En tant qu'experts en cybersécurité, nous avons délibérément choisi de ne pas inclure 
                        de formulaire sur notre site pour éliminer cette surface d'attaque.
                      </p>
                    </div>
                  </div>
                </div>
