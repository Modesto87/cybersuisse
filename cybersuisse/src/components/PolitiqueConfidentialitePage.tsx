                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="text-lg font-medium text-foreground">Nous collectons les informations suivantes :</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <p className="text-muted-foreground">Vos données personnelles sont utilisées uniquement pour :</p>
                      <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                        <li>Fournir nos services de cybersécurité (pentest, audit, surveillance)</li>
                  ...
                  <div className="space-y-4">
                    <h2 className="text-2xl font-semibold text-foreground">Conservation des Données</h2>
                    <p className="text-muted-foreground">
                  ...
                  {/* Cookies */}
                  <div className="space-y-4">
                    <h2 className="text-2xl font-semibold text-foreground">Cookies et Technologies Similaires</h2>
                    <p className="text-muted-foreground">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-muted/50 p-4 rounded-lg">
                      <p className="text-foreground"><strong>Modesto - CyberSuisse</strong></p>
                      <p className="text-muted-foreground">E-mail : modesto@cybersuisse.ch</p>
                      <p className="text-muted-foreground">Téléphone : 078 208 95 45</p>
                      <p className="text-muted-foreground">Région : Bienne, Suisse</p>
                    </div>
                  </div>
