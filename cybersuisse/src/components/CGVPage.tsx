      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold">1. Objet et champ d'application</h2>
                </div>
                <div className="prose prose-gray max-w-none">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    surveillance légère des menaces, audit CRA, développement sécurisé, services DFIR et 
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4">2. Description des prestations</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Tests d'intrusion (Pentest)</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Surveillance légère des menaces</h3>
                    <p className="text-muted-foreground">
                      Service de surveillance efficace mais léger, adapté aux PME, ne constituant pas un SOC complet. 
                      Monitoring des endpoints et alertes en cas de menaces détectées.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Audit CRA (Cyber Resilience Act)</h3>
                    <p className="text-muted-foreground">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Développement sécurisé</h3>
                    <p className="text-muted-foreground">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Services DFIR</h3>
                    <p className="text-muted-foreground">
                      Investigation numérique et réponse aux incidents de sécurité, analyse forensique, 
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold">3. Tarifs et modalités de paiement</h2>
                </div>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold">4. Délais d'exécution</h2>
                </div>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4">5. Confidentialité et sécurité</h2>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4">8. Droit applicable et juridiction</h2>
                <div className="space-y-4">
                  <p className="text-muted-foreground">
          ...
          >
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="p-8">
                <h3 className="text-xl font-semibold mb-4">Questions sur nos CGV ?</h3>
