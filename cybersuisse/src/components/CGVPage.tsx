      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold text-white">{copy.sections.s1.title}</h2>
                </div>
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-white">{copy.sections.s2.title}</h2>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-red-400">{copy.sections.s2.pentestTitle}</h3>
                    <p className="text-gray-400">{copy.sections.s2.pentestText}</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-red-400">{copy.sections.s2.craTitle}</h3>
                    <p className="text-gray-400">{copy.sections.s2.craText}</p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg mb-2 text-red-400">{copy.sections.s2.devTitle}</h3>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold text-white">{copy.sections.s3.title}</h2>
                </div>
                <div className="space-y-4">
                  <p className="text-gray-400">{copy.sections.s3.p1}</p>
                  <div>
                    <h3 className="font-semibold mb-2 text-red-400">{copy.sections.s3.paymentTitle}</h3>
            ...
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-semibold text-white">{copy.sections.s4.title}</h2>
                </div>
                <div className="space-y-4">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-white">{copy.sections.s5.title}</h2>
                <div className="space-y-4">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-white">{copy.sections.s6.title}</h2>
                <div className="space-y-4">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-white">{copy.sections.s7.title}</h2>
                <div className="space-y-4">
          ...
          >
            <Card className="hover:shadow-lg transition-shadow duration-300 bg-[#1A1A1A] border-[#333] hover:border-red-600/40">
              <CardContent className="p-8">
                <h2 className="text-2xl font-semibold mb-4 text-white">{copy.sections.s8.title}</h2>
                <div className="space-y-4">
          ...
          >
            <Card className="bg-gradient-to-br from-red-950/30 to-orange-950/20 border-red-800/40">
              <CardContent className="p-8">
                <h3 className="text-xl font-semibold mb-4 text-white">{copy.contactTitle}</h3>
